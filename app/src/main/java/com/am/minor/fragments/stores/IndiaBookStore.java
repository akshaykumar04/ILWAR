...
public class IndiaBookStore extends Fragment {

    private WebView bookStore;
    private String base_url = "https://www.indiabookstore.net/search?q=";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT, "Hey! checkout this book on IndiaBookStore at the cheapest price at\n\n" + base_url + isbn
